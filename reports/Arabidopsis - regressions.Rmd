...
* 10-folds CV (coordinated with the UNIBA group, they provided the list of samples for each fold)
* only kinship-based regressors: GBLUP and RKHS (Bayesian GBLUP)
* kinship computed following the [Astle&Balding method](https://www.jstor.org/stable/25681325)
* the whole process repeated five times for numerical stability, presented results are averaged

```{r echo=FALSE, include=TRUE}
#loading result data
res = read.csv('/home/nelson/research/crea-za_2024_geno_pheno_arabidopsis/results/accuracy_regression2_coordinated_CV.csv', stringsAsFactors = FALSE)
